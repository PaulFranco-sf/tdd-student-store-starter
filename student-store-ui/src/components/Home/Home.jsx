          ...
          <div className="summary">
            <ul className="info">
              ...
              <li>
                ...
                <span className="nowrap">1-800-CODEPATH</span>
              </li>
              <li>
                <span className="label">Address:</span>
                <span className="nowrap">123 Fake Street, San Francisco, CA</span>
              </li>
              <li>
                <span>Socials: </span>{' '}
            ...
            <div className="media">
              <img src={ContactPic} alt="codepath large" />
            </div>
          </div>
        </div>
      </div>
